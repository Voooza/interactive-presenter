...
**YOU ARE IN: `interactive_presenter/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/interactive_presenter/` (rig root) or other directories
...
**Your mail address:** `interactive_presenter/polecats/rust`
**Your rig:** interactive_presenter
**Your Witness:** `interactive_presenter/witness`
...
| Ask Witness for help | `gt mail send interactive_presenter/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`interactive_presenter/witness`) when:
...
```bash
gt mail send interactive_presenter/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
